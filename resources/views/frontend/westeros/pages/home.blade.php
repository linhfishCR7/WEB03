...
<!-- BANNER -->
	<div id="banner-wrap">
		<section id="banner">
			<div class="main-promo">
				<h2>Welcome to<br><span>LINHFFISH</span></h2>
	...
	<!-- /ADVERTISING -->
	@include('frontend.westeros.widgets.featureProduct', [$ds_sanpham = $ds_sanpham])
	...
	<div id="billboard-wrap">
		<section id="billboard">
			...
			<div class="sale-promo">
				...
				<img src="{{ asset('themes/westeros/images/bunny-monster.png')}}" alt="bunny-monster">
				<div id="bubbles">
