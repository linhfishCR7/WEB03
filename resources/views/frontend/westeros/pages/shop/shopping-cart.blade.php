    ...
    <section id="shop">
        ...
        <div class="shop-products">
                    ...
                    <div class="profile-column">
                        ...
                        <div class="featured-form">
                            <form class="westeros-form">
                                ...
                                <button class="button login"><a href="/xac-thuc">Continue</a></button>
                            </form>
                        </div>
                    </div>
                    <!-- /PROFILE COLUMN -->
            ...
            <button form="checkout-form" class="button checkout-button">Place order now!</button>
                    ...
                    <ngcart-checkout service="paypal" template-url="{{ asset('vendor/ngCart/template/ngCart/checkout.html') }}"></ngcart-checkout>
...
<div class="container" ng-controller="orderController">
    <form name="orderForm" id="orderForm" ng-submit="submitOrderForm()" novalidate>
        <div class="row">
        ...
        <!-- Nút submit form -->
        <button type="submit" class="button checkout-button" ng-disabled="orderForm.$invalid && ngCart.getTotalItems() === 0">
            Thanh toán
        </button>
    </form>
</div>
        ...
        $scope.submitOrderForm = function() {
            ...
            if ($scope.orderForm.$valid) {
                ...
                $http({
                    ...
                    Swal.fire('Đơn hàng hoàn tất!', 'Xin cám ơn Quý khách!', 'success');
                    ...
                    Swal.fire('Có lỗi trong quá trình thực hiện Đơn hàng!', 'Vui lòng thử lại sau vài phút.', 'error');
...
<!-- Checkout -->
<script src="{{ asset('themes/westeros/js/profile.js')}}"></script>
@endsection
