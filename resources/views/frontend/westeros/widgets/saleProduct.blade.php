...
<div class="product-showcase-wrap">
    <section class="product-showcase">
        ...
        <!-- COMPARE MODAL -->
        @include('frontend.westeros.widgets.compareProduct')
        <!-- /COMPARE MODAL -->
        ...
        <ul id="owl-f-products" class="product-list grid owl-carousel" >
            ...
            <li class="list-item" style="height:570px">
                <!-- ACTIONS -->
                @include('frontend.westeros.widgets.quickSaleProduct', ['ds_sanpham_giamdan' => $ds_sanpham_giamdan])
                <!-- /ACTIONS -->
                
                <!-- DESCRIPTION -->
                @include('frontend.westeros.widgets.descriptionSale', ['ds_sanpham_giamdan' => $ds_sanpham_giamdan])
                <!-- /DESCRIPTION -->
            </li>
            <!-- /PRODUCT -->
            @endforeach
