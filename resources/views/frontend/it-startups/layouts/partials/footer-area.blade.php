        <footer class="footer-area">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-footer-widget">
                            <div class="logo">
                                <a href="#"><img src="{{ asset('themes/it-startups/assets/img/white-logo.png')}}" alt="image"></a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-footer-widget">
                            ...
                            <ul class="footer-contact-list">
                                <li><span>Address:</span> Phu Binh Phu Tan, An Giang</li>
                                <li><span>Email:</span> <a href="#">havanlinh19042000@gmail.com</a></li>
                                <li><span>Phone:</span> <a href="#">+84 342 878767</a></li>
                                <li><span>Fax:</span> <a href="#">+84 342 878767</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <p>Copyright 2021 <a href="https://linhfishcr7.wordpress.com/">LINHFISH</a>. All Rights Reserved.</p>
                        </div>
            ...
            <div class="circle-map"><img src="{{ asset('themes/it-startups/assets/img/circle-map.png')}}" alt="image"></div>
        </footer>