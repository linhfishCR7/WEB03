...
class CreatePhieunhap extends Migration
{
    ...
    public function up()
    {
        Schema::create('phieunhap', function (Blueprint $table) {
            ...
            $table->foreign('nv_keToan')->references('nv_ma')->on('nhanvien')->onDelete('RESTRICT')->onUpdate('CASCADE');
            $table->foreign('nv_nguoiLapPhieu')->references('nv_ma')->on('nhanvien')->onDelete('RESTRICT')->onUpdate('CASCADE');
            $table->foreign('nv_thuKho')->references('nv_ma')->on('nhanvien')->onDelete('RESTRICT')->onUpdate('CASCADE');
        });
