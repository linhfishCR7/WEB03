...
class CreateKhuyenmai extends Migration
{
    ...
    public function up()
    {
        Schema::create('khuyenmai', function (Blueprint $table) {
            ...
            $table->unique(['km_ten']);
            $table->foreign('nv_kyDuyet')->references('nv_ma')->on('nhanvien')->onDelete('RESTRICT')->onUpdate('CASCADE');
            $table->foreign('nv_kyNhay')->references('nv_ma')->on('nhanvien')->onDelete('RESTRICT')->onUpdate('CASCADE');
            $table->foreign('nv_nguoiLap')->references('nv_ma')->on('nhanvien')->onDelete('RESTRICT')->onUpdate('CASCADE');
        });
